...
# optimizer_D = torch.optim.RMSprop(discriminator.parameters(),lr=learn_rate)
# optimizer_G = torch.optim.RMSprop(generator.parameters(),lr=learn_rate)
...
for epoch in range(config["n_epochs"]):
    for i,imgs in enumerate(dataloader):
        ...
        loss_log_writer.writerow([g_loss.item(),d_loss.item()])
